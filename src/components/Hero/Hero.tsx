    ...
    return (
        <div className="relative w-full h-auto lg:h-[764px]">
            ...
            <Image
                src={Deco}
                alt="deco"
                className="absolute top-[-149px] left-[192px] transform -translate-x-1/2 lg:left-[890px] lg:right-0 z-10"
            />
            <div className="relative w-full lg:w-[1200px] pt-[112px] z-10 px-4 lg:px-0">
                ...
                <PlaneAnimation className="z-10 absolute left-[-10px] transform -translate-x-1/2 top-[150px] lg:left-[500px] lg:translate-x-0 lg:top-[100px]">
                ...
                <div className="w-full lg:w-[630px] h-auto lg:h-[535px] relative mt-[250px] lg:mt-0">
                    ...
                    <div className="relative">
                        <Text size="h1" className="font-volkhov text-[#181E4B] pb-[30px] relative z-10 text-center lg:text-left">
                            Travel, enjoy and live a new and full life
                        </Text>
                        <div className="absolute w-[155px] h-[6px] md:w-[385px] md:h-[12px] top-[30px] md:top-[80px] left-[110px] md:left-[245px] z-0">
                            <Image src={Decore} alt="decore" />
                        </div>
                    </div>
                    <Text size="p" className="leading-[30px] text-[#5E6282] text-center lg:text-left">
            ...
            <PlaneAnimation className="z-10 absolute top-[150px] left-[0px] transform -translate-x-1/2 lg:left-[980px] lg:translate-x-0 lg:top-[150px]">
